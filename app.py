...
app = Flask(__name__)
# Chave essencial para as mensagens "Bom trabalho meu bem" aparecerem
app.secret_key = os.environ.get('SECRET_KEY', 'clinica_thamiris_998877')
...
def get_db_connection():
    ...
    # Adicionado sslmode para garantir estabilidade no Render
...
def bater_ponto():
    ...
    # Ajuste do formato para o banco profissional
...
def painel_gestao():
    ...
    try:
        ...
        return f"Erro na gestão: {e}", 500

@app.route('/init_db')
def force_init():
    init_db()
    return "Banco da Dra Thamiris inicializado com sucesso!"
